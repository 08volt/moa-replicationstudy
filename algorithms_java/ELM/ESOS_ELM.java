...
import moa.dabrze.classifiers.ann.ELM;
import moa.dabrze.classifiers.ann.OS_ELM;
import moa.dabrze.classifiers.ann.WELM;
...
public class ESOS_ELM extends AbstractClassifier implements MultiClassClassifier
{
    public ClassOption ensembleClassifier = new ClassOption("ensembleClassifier", 'c',
            "Classifier used in ensemble", OS_ELM.class, "moa.dabrze.classifiers.ann.OS_ELM");
